...
const AlbumPage = () => {
    ...
    const handlePlayAlbum = () => {
        ...
        const isCurrentAblumPlaying = currentAlbum?.songs.some(song => song._id === currentSong?._id)
        if (isCurrentAblumPlaying) togglePlay();
        else {
        ...
        <div className="h-full">
            <ScrollArea className="h-full rounded-md">
                ...
                <div className="relative min-h-full">
                    {/* bg gradient */}
                    <div area-hidden="true" className="absolute inset-0 bg-gradient-to-b from-[#5038a0]/80 via-zinc-900/80 to-zinc-900 pointer-events-none"/>

                    {/* Content  */}
                    <div className="relative z-10">
                        <div className="flex p-6 gap-6 pg-8">
                            ...
                            <div className="px-6">
                                <div className="space-y-2 p-4">
                                    {currentAlbum?.songs.map((song,index) => {
                                        ...
                                        <div key={song._id} onClick={() => handlePlaySong(index)} className="grid grid-cols-[16px_4fr_2fr_1fr] gap-4 px-4 py-2 text-sm text-zinc-400 hover:bg-white/5 rounded-b-md group cursor-pointer">
